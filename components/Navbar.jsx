...
import { User, LogOut, Settings, Heart, Menu, X, Activity } from "lucide-react";
        ...
        <div className=" mx-auto px-4 sm:px-6 lg:px-8 mb-20">
          ...
          >
            ...
            >
              ...
              <Link
                href="/"
                className="text-xl lg:text-2xl font-bold text-black tracking-wide hover:text-[#c1e141] transition-colors duration-200"
              >
                Vital Circle
              </Link>
            </motion.div>
                ...
                {!user && (
                  ...
                  >
                    ...
                    >
                      <Button
                        variant="ghost"
                        className="w-full justify-start text-black hover:bg-black/5"
                      >
                        Sign In
                      </Button>
                    </Link>
